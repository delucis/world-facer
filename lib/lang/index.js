...
module.exports = (function () {
  ...
  return {
    ...
    /**
     * Get a generator from an iterable that allows you to call .next() to get
     * the next value in sequence
     * @param  {Array|String|Map|Set} iterable An iterable to generate from
     * @return {Generator} A generator that returns items from the iterable
     */
    getIterator: function (iterable) {
      VLDT('A|S|M|C', [iterable])
