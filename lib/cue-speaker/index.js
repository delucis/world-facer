...
const cues = [
  ...
  // 13 - soft entrance
  ['Finish your note or phrase and then stop playing', { path: '13-ob' }],
  ...
  ['Prepare to rustle plastic', { path: '14-ob-1' }],
  ['Gently rustle plastic', { path: '14-ob-2' }],
  ['Prepare to use the metal brush', { path: '14-vn-1' }],
  ['Gently brush the poly styrene', { path: '14-vn-2' }],

  // 15 - hard cut
  ['Release chord in [[rate 90]] 3, 2, 1, go', { path: '15-kb' }],
